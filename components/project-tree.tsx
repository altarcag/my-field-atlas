 ...
 return <div className="project-tree">{groups.map(group=>{
  ...
  return <section className="project-group" key={group.id} aria-label={group.name}>
   <div className="project-heading">
    ...
    {canDelete&&!group.unassigned&&<button className="icon-button" title="Delete project" aria-label={"Delete project "+group.name} onClick={()=>onDeleteProject(group.id)}><Trash2 size={16}/></button>}
   </div>
