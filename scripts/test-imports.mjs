...
for(const name of ["photo-groups","types","parse-track","kmz","validation","projects","upload-auth","workspaces"]) {
...
const result=spawnSync(process.execPath,["--test","tests/photo-groups.test.mjs","tests/import.test.mjs","tests/projects.test.mjs","tests/workspaces.test.mjs"],{cwd:root,stdio:"inherit"});
