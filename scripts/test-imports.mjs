...
for(const name of ["types","parse-track","kmz","validation","projects","upload-auth"]) {
...
const result=spawnSync(process.execPath,["--test","tests/import.test.mjs","tests/projects.test.mjs"],{cwd:root,stdio:"inherit"});
